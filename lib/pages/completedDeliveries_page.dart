// ignore_for_file: file_names, prefer_const_constructors, library_private_types_in_public_api, unused_local_variable
...
class _CompletedDeliveriesPageState extends State<CompletedDeliveriesPage> {
  ...
  Widget build(BuildContext context) {
    ...
    List<ColisModel> completedColisList = colisProvider.colisList.where((colis) => colis.status == "Completed").toList();
   return Scaffold(
